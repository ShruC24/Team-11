<h1 class="pageTitle text-center">Report Found Item</h1>
<hr class="mx-auto bg-primary border-primary opacity-100" style="width:50px">
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
            <div class="card-body py-4">
                <h4 class="pageTitle"><b>Please fill all the required fields</b></h4>
                <form action="" id="item-form">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="fullname" id="fullname" class="form-control form-control-sm rounded-0" value="<?php echo isset($fullname) ? $fullname : ''; ?>"  autofocus title = "Please enter the Founder Name" required/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="title" class="control-label">Item Title</label>
                            <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" value="<?php echo isset($title) ? $title : ''; ?>"  title = "Please enter the Item Title" maxlength = 30 required/>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="contact" id="contact" class="form-control form-control-sm rounded-0" value="<?php echo isset($contact) ? $contact : ''; ?>"  title = "Please enter the contact number" required maxlength = 10 minlength = 10/>
                    </div> 
