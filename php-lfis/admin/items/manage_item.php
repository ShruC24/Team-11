    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card rounded-0">
            <div class="card-header py-0">
                <div class="card-title py-1"><b><?= isset($id) ? "Update Items Details" : "New Lost Items Entry" ?></b></div>
            </div>
            <div class="card-body">
                <div class="container-fluid mt-3">
                    <form action="" id="items-form">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="fullname" class="control-label">User Name</label>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="contact" id="contact" class="form-control form-control-sm rounded-0" value="<?php echo isset($contact) ? $contact : ''; ?>"  required maxlength="10"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#items-form').submit(function(e){
            e.preventDefault();
            var titleMaxLength = 30; // Set the desired maximum length for the title

            if ($('#title').val().length > titleMaxLength) {
                alert_toast('Title exceeds the maximum length of ' + titleMaxLength + ' characters.', 'error');
                return;
            }
            var titleMaxLength_contact = 10; // Set the desired maximum length for the contact

            if ($('#contact').val().length > titleMaxLength_contact) {
                alert_toast('Contact exceeds the maximum length of ' + titleMaxLength_contact + ' digits.', 'error');
                return;
            }
            ...
            if ($('#contact').val().length < contactMinLength) {
                alert_toast('Contact should have the minimum length of ' + contactMinLength + ' digits.', 'error');
                return;
            }

            var titleValue = $('#title').val();
            var alphanumericRegex = /^[a-zA-Z0-9\s]+$/;
            if (!alphanumericRegex.test(titleValue)) {
                alert_toast('Title can only contain alphanumeric characters.', 'error');
                return;
            }
